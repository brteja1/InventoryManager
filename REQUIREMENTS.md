...
- **Photo-First Capture**: Launch camera directly or select from gallery. Primary photo serves as the visual identifier.
...
- **Fuzzy Search**: Instant filtering by name, location, container, or tag. Disabled when the inventory is empty.
